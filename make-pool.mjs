...
const POOL = [
  ...
  { name: 'knee-kneeling',    s: `${GRANDMA} kneeling on a hard floor wiping it with a cloth, both knees pressed to the floor, seen from a low side angle.`, use: '슬개전 점액낭염, 무릎 꿇는 작업, 가사 노동' },
  { name: 'knee-swelling',    s: `A close-up of the front of an elderly persons bare knee, seated with the leg bent, the skin just over the kneecap visibly puffy and rounded, one hand resting beside it, dark background.`, use: '무릎 앞 붓기, 점액낭염, 물혹' },
  { name: 'knee-pad',         s: `A close-up of ${GRANDPA} kneeling on a folded cushion on the floor, a simple grey knee pad strapped over one knee, hands resting on his thigh.`, use: '무릎 보호대, 방석, 무릎 꿇을 때 보호' },
